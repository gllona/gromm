...
/**
 * Class for ORM proxy of type SINGLE_INSIDE_NULLABLE
 * 
 ...
 */
class ORMpairmapSingleInsideNullable extends ORMpairmap
{



    const MAGIC_NULL_VALUE = "666theNumberOfTheBeast";
    ...
    private function fetch_id_or_ids ()
    {
        ...
        $this->resolve_backlinks_factorized( $fieldname, $target_id, true );
        // return
        return true;
    }
    ...
    protected function instance_save_delegate ()
    {
        ...
        if ( $target_id == self::MAGIC_NULL_VALUE ) {
            $target_id = null;
        }
    ...
    public function get_id_or_ids ()
    {
        ...
        return $id == self::MAGIC_NULL_VALUE ? null : $id;
    }
    ...
    /**
     * @param null|int|ORMobject $argument
     * @throws ORMexception
     */
